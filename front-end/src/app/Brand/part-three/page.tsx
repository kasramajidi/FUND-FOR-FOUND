  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4 sm:px-6">
      ...
      <div className="flex flex-col items-center justify-center mt-8 flex-1 w-full lg:mt-[50px]">
        ...
        <Link href={"/profile"}>
          <button className="mt-4 sm:mt-6 px-4 py-2 sm:px-8 sm:py-2 bg-[rgba(100,79,193,1)] text-white rounded-md cursor-pointer text-base sm:text-lg font-semibold shadow hover:bg-[rgba(100,50,193)] transition w-full max-w-xs">
            Go to my profile
          </button>
        </Link>
      </div>
