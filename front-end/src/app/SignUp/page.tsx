    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-4 py-8 max-w-[440px] lg:max-w-[600px] mx-auto">
        <main className="flex flex-col items-center gap-6">
          ...
          <button className="w-full cursor-pointer py-3 px-4 border border-gray-200 rounded-lg bg-white text-gray-700 text-base hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
