...
const GoogleSingUp = () => {
  return (
    <Link
      href={"/SignUp/Verification_SignUp_google"}
      className="w-full border-gray-200  rounded-lg bg-white cursor-pointer py-3 px-4 border flex items-center justify-center text-gray-700 text-base hover:bg-gray-50 transition-colors"
    >
      <button className="flex items-center justify-center gap-2 w-full cursor-pointer">
